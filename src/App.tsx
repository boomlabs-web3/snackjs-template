...
function App() {
	...
	let wasmFile = "./zkproof/circuit.wasm";
	let zkeyFile = "./zkproof/circuit_final.zkey";
	let verificationKey = "./zkproof/verification_key.json";
	...
	const runProofs = () => {
		...
		makeProof(proofInput, wasmFile, zkeyFile)
